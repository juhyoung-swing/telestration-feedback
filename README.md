...
> 사용자가 쓰는 앱 셋은 [apps/](apps/README.md) 에, 사업·제품 결정은
> [docs/](docs/README.md) 에 있다. 로드맵과 이 저장소의 실측치가 아직 안 맞는
> 지점은 [docs/README.md](docs/README.md) 의 "문서 사이에 아직 안 맞는 것" 에 적었다.
...
데이터가 아닌 두 폴더가 더 있다. 영상 엔진과는 서로 참조하지 않는다.

```
apps/         사용자가 쓰는 제품 — 관리자 웹 · 코치 앱 · 학습자 앱. 아직 코드 없음
docs/         사업 로드맵 · 제품정의서 · MVP 기획서 · 리서치 · 온보딩
```
